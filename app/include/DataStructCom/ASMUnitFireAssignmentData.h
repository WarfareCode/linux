//ASMUnitFireAssignmentData.h: interface for the CASMUnitFireAssignmentData module.
//!!HDOSE_CLASS(CASMUnitFireAssignmentData,CEvt)
//////////////////////////////////////////////////////////////////////
...
#if !defined(AFX_ASMUnitFireAssignmentData_H)
#define AFX_ASMUnitFireAssignmentData_H


#include "WXCTime.h"
#include "NoFlyZoneData.h"
//{{HDOSE_CLS_DES(CASMUnitFireAssignmentData)
/*
Author:		
Version:	1.0
Descript:	
...
class DATASTRUCTCOMPONENTDLL_API CASMUnitFireAssignmentData /*反舰导弹单元火力分配数据*/ : public CEvt 
{
	DECLARE_CREATE;
public:
	CASMUnitFireAssignmentData();
	virtual ~CASMUnitFireAssignmentData();
	...
	//{{HDOSE_MEMBER_FUNCTION(CASMUnitFireAssignmentData)
	//}}HDOSE_MEMBER_FUNCTION

public:
	
	//{{HDOSE_ATTRIBUTE(CASMUnitFireAssignmentData)
	long	m_FieldNo/*阵地编号*/;
