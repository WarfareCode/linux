//SBMScheduleOrder.h: interface for the CSBMScheduleOrder module.
//!!HDOSE_CLASS(CSBMScheduleOrder,CEvt)
//////////////////////////////////////////////////////////////////////
...
#if !defined(AFX_SBMScheduleOrder_H)
#define AFX_SBMScheduleOrder_H



//{{HDOSE_CLS_DES(CSBMScheduleOrder)
/*
Author:		
Version:	1.0
Descript:	
...
class DATASTRUCTCOMPONENTDLL_API CSBMScheduleOrder /*岸导调度指令*/ : public CEvt 
{
	DECLARE_CREATE;
public:
	CSBMScheduleOrder();
	virtual ~CSBMScheduleOrder();
	...
	//{{HDOSE_MEMBER_FUNCTION(CSBMScheduleOrder)
	//}}HDOSE_MEMBER_FUNCTION

public:
	
	//{{HDOSE_ATTRIBUTE(CSBMScheduleOrder)
	long	m_FieldNo/*阵地编号*/;
	double	m_Speed/*航速*/;
	double	m_Course/*航向*/;
