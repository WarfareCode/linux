...
/* *-----------------------------------------------------------------------------*/
/** Checks the information in the given SRM_Axis_Angle_Params.
     ...
     @param error_count_ptr -- pointer to a variable in which the error count
                               for this SRM_Axis_Angle_Params is stored; if
...
/* *-----------------------------------------------------------------------------*/
/** Checks the information in the given SRM_Equatorial_Spherical_3D_Coordinate.
     ...
     @param error_count_ptr -- pointer to a variable in which the error count
                               for this SRM_Equatorial_Spherical_3D_Coordinate
       is stored; if NULL, no counting is performed.
     @return SRM_TRUE - if value_ptr is non-NULL and *value_ptr contains valid
                       information.
...
/* *-----------------------------------------------------------------------------*/
EXPORT_DLL extern SRM_Boolean
SRM_ValidEquatorialSpherical3DCoordinate
(
...
/* *-----------------------------------------------------------------------------*/
/** Checks the information in the given SRM_Euler_Angles_ZXZ_Params.
     ...
     @param error_count_ptr -- pointer to a variable in which the error count
                               for this SRM_Euler_Angles_ZXZ_Params is stored;
       if NULL, no counting is performed.
     @return SRM_TRUE - if value_ptr is non-NULL and *value_ptr contains valid
                       information.
...
/* *-----------------------------------------------------------------------------*/
/** Checks if the given value is a valid SRM_Ori_Rep_Type.
     @param value -- value to be checked
...
/* *-----------------------------------------------------------------------------*/
/** Checks the information in the given SRM_Tait_Bryan_Angles_Params.
     ...
     @param error_count_ptr -- pointer to a variable in which the error count
                               for this SRM_Tait_Bryan_Angles_Params is
       stored; if NULL, no counting is performed.
     @return SRM_TRUE - if value_ptr is non-NULL and *value_ptr contains valid
                       information.
...
/* *-----------------------------------------------------------------------------*/
EXPORT_DLL extern SRM_Boolean
SRM_ValidTaitBryanAnglesParams
(
