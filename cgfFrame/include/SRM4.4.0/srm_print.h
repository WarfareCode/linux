...
/** Prints the information in the given SRM_Axis_Angle_Params.
     @param value_ptr -- pointer to SRM_Axis_Angle_Params whose contents are
...
/* *-----------------------------------------------------------------------------*/
EXPORT_DLL extern void
SRM_PrintAxisAngleParams
(
    const SRM_Axis_Angle_Params *value_ptr,
    const char                  *name_ptr,
...
/** Prints the information in the given SRM_Equatorial_Spherical_3D_Coordinate.
     @param value_ptr -- pointer to SRM_Equatorial_Spherical_3D_Coordinate
...
/* *-----------------------------------------------------------------------------*/
EXPORT_DLL extern void
SRM_PrintEquatorialSpherical3DCoordinate
(
    const SRM_Equatorial_Spherical_3D_Coordinate *value_ptr,
    const char                                   *name_ptr,
          SRM_Integer_Unsigned                    level
);
...
/** Prints the information in the given SRM_Euler_Angles_ZXZ_Params.
     @param value_ptr -- pointer to SRM_Euler_Angles_ZXZ_Params whose contents
                  are to be printed; if NULL, prints error message and returns
                  to caller
...
/* *-----------------------------------------------------------------------------*/
EXPORT_DLL extern void
SRM_PrintEulerAnglesZXZParams
(
    const SRM_Euler_Angles_ZXZ_Params *value_ptr,
    const char                        *name_ptr,
          SRM_Integer_Unsigned         level
);
...
/** Prints the information in the given SRM_Matrix_3x3.
     @param value_ptr -- pointer to SRM_Matrix_3x3 whose contents are to be
                  printed; if NULL, prints error message and returns to caller
...
SRM_PrintMatrix3x3
(
    const SRM_Matrix_3x3       *value_ptr,
    const char                 *name_ptr,
          SRM_Integer_Unsigned  level
);
...
/** Prints the information in the given SRM_Matrix_4x4.
     @param value_ptr -- pointer to SRM_Matrix_4x4 whose contents are to be
                  printed; if NULL, prints error message and returns to caller
...
SRM_PrintMatrix4x4
(
    const SRM_Matrix_4x4       *value_ptr,
    const char                 *name_ptr,
          SRM_Integer_Unsigned  level
);
...
/* *-----------------------------------------------------------------------------*/
/** Translates the given SRM_Ori_Rep_Type into a buffer that is suitable for
     printing.

     @param value -- SRM_Ori_Rep_Type to be processed
...
/** Prints the information in the given SRM_Quaternion_Params.
     @param value_ptr -- pointer to SRM_Quaternion_Params whose contents are
                  to be printed; if NULL, prints error message and returns to
                  caller
...
/* *-----------------------------------------------------------------------------*/
EXPORT_DLL extern void
SRM_PrintQuaternionParams
(
    const SRM_Quaternion_Params *value_ptr,
    const char                  *name_ptr,
          SRM_Integer_Unsigned   level
);
...
/** Prints the information in the given SRM_Tait_Bryan_Angles_Params.
     @param value_ptr -- pointer to SRM_Tait_Bryan_Angles_Params whose
                  contents are to be printed; if NULL, prints error message
                  and returns to caller
...
/* *-----------------------------------------------------------------------------*/
EXPORT_DLL extern void
SRM_PrintTaitBryanAnglesParams
(
    const SRM_Tait_Bryan_Angles_Params *value_ptr,
    const char                         *name_ptr,
          SRM_Integer_Unsigned          level
);
...
/** Translates the information in the given SRM_Vector_2D into a buffer that
     @param value -- SRM_Vector_2D to be processed
...
SRM_PrintVector2D
(
    const SRM_Vector_2D value
);


/* *-----------------------------------------------------------------------------*/
/** Prints the information in the given SRM_Vector_3D.
     @param value_ptr -- pointer to SRM_Vector_3D whose contents are to be
                  printed; if NULL, prints error message and returns to caller
