 ...
 *
 */
#ifndef SRM_LOCALTANGENTSPACEAZIMUTHALSPHERICAL_H_INCLUDED
#define SRM_LOCALTANGENTSPACEAZIMUTHALSPHERICAL_H_INCLUDED
...
typedef struct
{
    ...
    SRM_ComputeSRFOrientation                 *ComputeSRFOrientation;
    SRM_CreateLococentricEuclidean3DSRF       *CreateLococentricEuclidean3DSRF;
    SRM_TransformOrientation                  *TransformOrientation;
    SRM_TransformOrientationCommonOrigin      *TransformOrientationCommonOrigin;
    SRM_TransformVectorInBodyFrame            *TransformVectorInBodyFrame;
    SRM_TransformVectorInBodyFrameCommonOrigin *TransformVectorInBodyFrameCommonOrigin;
    SRM_TransformVector                       *TransformVector;
    SRM_TransformVectorCommonOrigin           *TransformVectorCommonOrigin;
...
/** This creates a new Local Tangent Space Azimuthal Spherical SRF.
    ...
    @param parameters in: @param parameters in: parameters for Local Tangent Space Azimuthal Spherical
...
#endif
#endif /* #ifndef/define/endif for SRM_LOCALTANGENTSPACEAZIMUTHALSPHERICAL_H_INCLUDED */
