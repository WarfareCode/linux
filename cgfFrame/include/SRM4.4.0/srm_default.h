...
/*!
 * GLOBAL VARIABLE: SRM_AXIS_ANGLE_PARAMS_DEFAULT
 *
 *   Pre-initialized global variable containing the default values for an
 *   SRM_Axis_Angle_Params variable.
 */
EXPORT_DLL extern const SRM_Axis_Angle_Params SRM_AXIS_ANGLE_PARAMS_DEFAULT;
...
/*!
 * GLOBAL VARIABLE: SRM_EQUATORIAL_SPHERICAL_3D_COORDINATE_DEFAULT
 *
 *   Pre-initialized global variable containing the default values for an
 *   SRM_Equatorial_Spherical_3D_Coordinate variable.
 */
EXPORT_DLL extern const SRM_Equatorial_Spherical_3D_Coordinate
SRM_EQUATORIAL_SPHERICAL_3D_COORDINATE_DEFAULT;
...
/*!
 * GLOBAL VARIABLE: SRM_EULER_ANGLES_ZXZ_PARAMS_DEFAULT
 *
 *   Pre-initialized global variable containing the default values for an
 *   SRM_Euler_Angles_ZXZ_Params variable.
 */
EXPORT_DLL extern const SRM_Euler_Angles_ZXZ_Params
SRM_EULER_ANGLES_ZXZ_PARAMS_DEFAULT;
...
/*!
 * GLOBAL VARIABLE: SRM_QUATERNION_PARAMS_DEFAULT
 *
 *   Pre-initialized global variable containing the default values for an
 *   SRM_Quaternion_Params variable.
 */
EXPORT_DLL extern const SRM_Quaternion_Params SRM_QUATERNION_PARAMS_DEFAULT;
...
/*!
 * GLOBAL VARIABLE: SRM_TAIT_BRYAN_ANGLES_PARAMS_DEFAULT
 *
 *   Pre-initialized global variable containing the default values for an
 *   SRM_Tait_Bryan_Angles_Params variable.
 */
EXPORT_DLL extern const SRM_Tait_Bryan_Angles_Params
SRM_TAIT_BRYAN_ANGLES_PARAMS_DEFAULT;
